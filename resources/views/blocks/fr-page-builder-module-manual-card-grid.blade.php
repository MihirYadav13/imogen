                            ...
                            <div class="card-content">
                                <div class="wysiwyg-content">
                                    ...
                                    <div class="card-footer">
                                        <x-cta-button :label="$card_data['cta_link']['title']?:'Learn More'" :style="margin-left=110px" :external-url="$card_data['cta_link']['url']" :newTab="$card_data['cta_link']['target']" type="external_url" :style="'regular-link'" />
                                    </div>
                                </div>
                            </div>
                        </div>
