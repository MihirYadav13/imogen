            ...
            <div class="wysiwyg-content">
                ...
                @if(!empty($card_data['registration_link']) || (!empty($card_data['action_cta']) && $post_type === 'post'))
                    <div class="card-footer">
                        ...
                        <x-cta-button label="{!! $post_type === 'after-school-program' ? 'Schedule & Registration' : 'Information & Registration' !!}" type="external_url" :external-url="$card_data['registration_link']" style="primary"/>
                        @endif
